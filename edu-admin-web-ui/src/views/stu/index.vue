...
<template>
  <div class="page-container">
    ...
    <div class="toolbar">
      <el-button type="primary" @click="addStu();resetForm(stuFormRef)">+ 新增学员</el-button>
      <el-button type="danger" @click="delByIds()">- 批量删除</el-button>
    </div>

    <div class="table-card">
      <el-table :data="tableData" style="width: 100%" fit @selection-change="handleSelectionChange">
