...
import com.eduadmin.pojo.EmpQueryParam;
...
public interface EmpMapper {
     ...
     * 查询全部员工
     */
    @Select("select id, username, password, name, gender, phone, job, salary, entry_date, dept_id, create_time, update_time from emp")
    List<Emp> findAll();
